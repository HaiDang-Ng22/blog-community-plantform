...
*   **Xác thực người bán bằng CCCD & Sinh trắc học**: Quy trình tải lên ảnh CCCD mặt trước/sau + ảnh chụp Selfie, sử dụng AI để OCR tự động điền thông tin và so khớp khuôn mặt (Face Matching) liveness check an toàn.
