...
*   **Marketplace & Discovery**: Giao diện mua sắm Glassmorphism hiện đại, hỗ trợ duyệt sản phẩm theo danh mục đa cấp (Recursive Category), tìm kiếm và xem chi tiết sản phẩm.
...
*   **Quản lý Đơn hàng**: Hệ thống cập nhật trạng thái đơn hàng thời gian thực, đồng bộ dữ liệu giữa người mua và người bán. Hỗ trợ đầy đủ các trạng thái từ Chờ xác nhận đến Hoàn thành.
